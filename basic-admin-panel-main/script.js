...
//     let paragraph = document.getElementById("table-wrapper");
...
//     var inputText = document.getElementById("table-section");
//     var innerHTML = inputText.innerHTML;
//     var index = innerHTML.indexOf(text);
//     if (index >= 0) { 
//      innerHTML = innerHTML.substring(0,index) + "<div id='table-data'>" + innerHTML.substring(index,index+text.length) + "</div>" + innerHTML.substring(index + text.length);
...
// );
const $box = document.getElementById('table-section');
const $search = document.getElementById('search-box');
